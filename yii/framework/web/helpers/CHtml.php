...
class CHtml
{
	 ...
	 */
	public static $errorSummaryCss='alert alert-danger alert-border-left alert-dismissable fs13';
	/**
	 ...
	 * @see label
	 */
	public static $afterRequiredLabel=' <span class="required"><i class="fa fa-asterisk fs8" style="vertical-align:top !important"></i></span>';
	/**
...
EOD;
	...
	public static function errorSummary($model,$header=null,$footer=null,$htmlOptions=array())
	{
		...
		{
			if($header===null)
				$header='<p>'.Yii::t('yii','Betulkan kesilapan input yang berikut:').'</p>';
			if(!isset($htmlOptions['class']))
