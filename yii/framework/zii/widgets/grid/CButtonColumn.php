...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $viewButtonLabel='<i class="fa fa-search"></i>';
	/**
	 ...
	 */
	public $viewButtonOptions=array('class'=>'btn btn-primary btn-xs mt5','rel'=>'tooltip','data-toggle'=>'tooltip','title'=>'View');
	 ...
	 */
	public $updateButtonOptions=array('class'=>'btn btn-info btn-xs mt5','rel'=>'tooltip','data-toggle'=>'tooltip','title'=>'Update');

	/**
	 * @var string the label for the delete button. Defaults to "Delete".
	 * Note that the label will not be HTML-encoded when rendering.
	 */
	public $deleteButtonLabel='<i class="fa fa-trash-o">';
	/**
	 ...
	 */
	public $deleteButtonOptions=array('class'=>'btn btn-danger btn-xs mt5','rel'=>'tooltip','data-toggle'=>'tooltip','title'=>'Delete');
	/**
