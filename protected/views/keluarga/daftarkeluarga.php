...
$jawatan = CHtml::listData($jawatan, 'nama','nama');
                        ...
                        <div class="panel mt20 mb50 sort-disable" id="p0" data-panel-title="false" data-panel-fullscreen="false" data-panel-remove="false" data-panel-collapse="false" data-panel-fullscreen="false">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                <?php echo $form->textField($model,'mukim',array('class'=>'form-control wauto')); ?>
                             ...
                             <tr>
                                ...
                                <td>
                                <?php echo $form->textField($model,'kampung',array('class'=>'form-control wauto')); ?>
                             ...
                             <tr>
                                <td width="30%"><?php echo $form->labelEx($model,'status_ahli'); ?></td>
                                <td>
                                <?php echo $form->dropDownList($model,'status_ahli',array('1'=>'1'),array('class'=>'form-control wauto', 'empty'=>'[Status Ahli]')); ?>
                             ...
                             <tr>
                                ...
                                <td>
                                <?php echo $form->dropDownList($model,'parlimen',array('1'=>'1'),array('class'=>'form-control wauto', 'empty'=>'[Pilih]')); ?>
                             ...
                             <tr>
                                ...
                                <td>
                                <?php echo $form->dropDownList($model,'dun',array('1'=>'1'),array('class'=>'form-control wauto', 'empty'=>'[Pilih]')); ?>
