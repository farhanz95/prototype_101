...
//  }
  ...
  public function rules() {
    ...
    // array('name', 'safe', 'on'=>'roles_search'),
    );
  }
...
//  }
   ...
   */
  public function roles_search(){
    $criteria = new CDbCriteria;
    $criteria->compare('name',$this->name,true);

    $criteria->addSearchCondition('name', 'Developer', false, 'And', 'NOT LIKE');
    $criteria->addSearchCondition('type', 2);
  ...
  public function getUnassignedTasks(){
    return(Helper::getRoleNotAssignedTasks($this->name));
  }
}